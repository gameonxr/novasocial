...
| H10-14 | 2026-09-07 | INFO | RESOLVED 2026-09-19 via XSS-C1 (the C1 helper fix removed the dead safeName line; security aspect was tracked as XSS-C1 in SECURITY_ISSUES.md — now FIXED, see §26) | utils.js:329 — av() computes safeName (quote+quot escape) but never uses it | Dead variable inside av() | Remove or use in the av() review task | removed by XSS-C1 commit | 2026-09-19 |
