...
assert.strictEqual(files.length, 232, 'index.html plus 231 extracted modules must be audited after the DMs renderer owner split');
assert.strictEqual(matches.length, 218, 'application surface must retain 218 explicit window assignments after the Notes reaction owner split');
