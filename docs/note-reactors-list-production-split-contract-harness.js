...
assert.strictEqual(sourceModules, 222, 'source module count must include the Notes reactor-list owner, admin filter owner, refresh counts owner, and reports filter owner');
