...
assert.strictEqual(sourceModules, 223, 'source module count must include the Notes reactor-list owner, admin filter owner, refresh counts owner, reports filter owner, and verification filter owner');
