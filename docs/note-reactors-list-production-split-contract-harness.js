...
assert.strictEqual(sourceModules, 335, 'source module count must include the Notes reactor-list owner, DMs owner, admin filter owner, refresh counts owner, reports filter owner, verification filter owner, toggleSVMute owner, invalidateTabCache owner, and confirmCropPreview owner');
