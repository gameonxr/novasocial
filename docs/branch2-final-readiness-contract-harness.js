...
assert.strictEqual(allDocs.length, 238, '238 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 238, '238 harness files must be published');
assert.strictEqual(contractFiles.length, 236, '236 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 235, '235 standard contract harnesses must be published');
