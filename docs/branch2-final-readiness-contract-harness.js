...
assert.strictEqual(allDocs.length, 123, '123 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 123, '123 harness files must be published');
assert.strictEqual(contractFiles.length, 121, '121 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 120, '120 standard contract harnesses must be published');
