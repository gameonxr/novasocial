...
assert.strictEqual(allDocs.length, 128, '128 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 128, '128 harness files must be published');
assert.strictEqual(contractFiles.length, 126, '126 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 125, '125 standard contract harnesses must be published');
