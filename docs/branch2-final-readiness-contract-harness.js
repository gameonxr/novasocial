...
assert.strictEqual(allDocs.length, 229, '229 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 229, '229 harness files must be published');
assert.strictEqual(contractFiles.length, 227, '227 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 226, '226 standard contract harnesses must be published');
