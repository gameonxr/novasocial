...
assert.strictEqual(allDocs.length, 77, '77 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 77, '77 harness files must be published');
assert.strictEqual(contractFiles.length, 75, '75 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 74, '74 standard contract harnesses must be published');
