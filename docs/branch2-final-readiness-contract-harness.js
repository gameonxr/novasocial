...
assert.strictEqual(allDocs.length, 147, '147 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 147, '147 harness files must be published');
assert.strictEqual(contractFiles.length, 145, '145 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 144, '144 standard contract harnesses must be published');
