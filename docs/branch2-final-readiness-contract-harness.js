...
assert.strictEqual(allDocs.length, 127, '127 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 127, '127 harness files must be published');
assert.strictEqual(contractFiles.length, 125, '125 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 124, '124 standard contract harnesses must be published');
