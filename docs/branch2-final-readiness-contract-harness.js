...
assert.strictEqual(allDocs.length, 207, '207 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 207, '207 harness files must be published');
assert.strictEqual(contractFiles.length, 205, '205 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 204, '204 standard contract harnesses must be published');
