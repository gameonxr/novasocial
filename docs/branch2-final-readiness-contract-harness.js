...
assert.strictEqual(allDocs.length, 94, '94 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 94, '94 harness files must be published');
assert.strictEqual(contractFiles.length, 92, '92 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 91, '91 standard contract harnesses must be published');
