...
assert.strictEqual(allDocs.length, 148, '148 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 148, '148 harness files must be published');
assert.strictEqual(contractFiles.length, 146, '146 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 145, '145 standard contract harnesses must be published');
