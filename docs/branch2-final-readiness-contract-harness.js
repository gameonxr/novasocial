...
assert.strictEqual(allDocs.length, 190, '190 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 190, '190 harness files must be published');
assert.strictEqual(contractFiles.length, 188, '188 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 187, '187 standard contract harnesses must be published');
