...
assert.strictEqual(allDocs.length, 164, '164 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 164, '164 harness files must be published');
assert.strictEqual(contractFiles.length, 162, '162 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 161, '161 standard contract harnesses must be published');
