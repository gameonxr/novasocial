...
assert.strictEqual(allDocs.length, 206, '206 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 206, '206 harness files must be published');
assert.strictEqual(contractFiles.length, 204, '204 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 203, '203 standard contract harnesses must be published');
