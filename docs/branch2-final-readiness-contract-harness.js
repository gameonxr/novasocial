...
assert.strictEqual(allDocs.length, 121, '121 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 121, '121 harness files must be published');
assert.strictEqual(contractFiles.length, 119, '119 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 118, '118 standard contract harnesses must be published');
