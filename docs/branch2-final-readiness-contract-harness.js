...
assert.strictEqual(allDocs.length, 227, '227 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 227, '227 harness files must be published');
assert.strictEqual(contractFiles.length, 225, '225 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 224, '224 standard contract harnesses must be published');
