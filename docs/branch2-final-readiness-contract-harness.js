...
assert.strictEqual(allDocs.length, 216, '216 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 216, '216 harness files must be published');
assert.strictEqual(contractFiles.length, 214, '214 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 213, '213 standard contract harnesses must be published');
