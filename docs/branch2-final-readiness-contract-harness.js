...
assert.strictEqual(allDocs.length, 74, '74 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 74, '74 harness files must be published');
assert.strictEqual(contractFiles.length, 72, '72 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 71, '71 standard contract harnesses must be published');
