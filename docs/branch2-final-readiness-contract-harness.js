...
assert.strictEqual(allDocs.length, 193, '193 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 193, '193 harness files must be published');
assert.strictEqual(contractFiles.length, 191, '191 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 190, '190 standard contract harnesses must be published');
