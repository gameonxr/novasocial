...
assert.strictEqual(allDocs.length, 247, '247 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 247, '247 harness files must be published');
assert.strictEqual(contractFiles.length, 245, '245 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 244, '244 standard contract harnesses must be published');
