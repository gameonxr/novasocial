...
assert.strictEqual(allDocs.length, 249, '249 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 249, '249 harness files must be published');
assert.strictEqual(contractFiles.length, 247, '247 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 246, '246 standard contract harnesses must be published');
