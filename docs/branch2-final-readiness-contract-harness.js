...
assert.strictEqual(allDocs.length, 90, '90 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 90, '90 harness files must be published');
assert.strictEqual(contractFiles.length, 88, '88 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 87, '87 standard contract harnesses must be published');
