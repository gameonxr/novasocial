...
assert.strictEqual(allDocs.length, 124, '124 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 124, '124 harness files must be published');
assert.strictEqual(contractFiles.length, 122, '122 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 121, '121 standard contract harnesses must be published');
