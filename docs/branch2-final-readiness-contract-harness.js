...
assert.strictEqual(allDocs.length, 221, '221 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 221, '221 harness files must be published');
assert.strictEqual(contractFiles.length, 219, '219 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 218, '218 standard contract harnesses must be published');
