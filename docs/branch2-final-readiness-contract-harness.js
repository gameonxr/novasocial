...
assert.strictEqual(allDocs.length, 226, '226 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 226, '226 harness files must be published');
assert.strictEqual(contractFiles.length, 224, '224 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 223, '223 standard contract harnesses must be published');
