...
assert.strictEqual(allDocs.length, 115, '115 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 115, '115 harness files must be published');
assert.strictEqual(contractFiles.length, 113, '113 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 112, '112 standard contract harnesses must be published');
