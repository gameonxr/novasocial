...
assert.strictEqual(allDocs.length, 251, '251 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 251, '251 harness files must be published');
assert.strictEqual(contractFiles.length, 249, '249 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 248, '248 standard contract harnesses must be published');
