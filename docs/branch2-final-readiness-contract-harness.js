...
assert.strictEqual(allDocs.length, 233, '233 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 233, '233 harness files must be published');
assert.strictEqual(contractFiles.length, 231, '231 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 230, '230 standard contract harnesses must be published');
