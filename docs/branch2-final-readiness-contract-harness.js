...
assert.strictEqual(contractFiles.length, 69, '69 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 68, '68 standard contract harnesses must be published');
