...
assert.strictEqual(allDocs.length, 134, '134 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 134, '134 harness files must be published');
assert.strictEqual(contractFiles.length, 132, '132 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 131, '131 standard contract harnesses must be published');
