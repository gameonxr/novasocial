...
assert.strictEqual(allDocs.length, 205, '205 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 205, '205 harness files must be published');
assert.strictEqual(contractFiles.length, 203, '203 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 202, '202 standard contract harnesses must be published');
