...
assert.strictEqual(allDocs.length, 167, '167 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 167, '167 harness files must be published');
assert.strictEqual(contractFiles.length, 165, '165 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 164, '164 standard contract harnesses must be published');
