...
assert.strictEqual(allDocs.length, 78, '78 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 78, '78 harness files must be published');
assert.strictEqual(contractFiles.length, 76, '76 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 75, '75 standard contract harnesses must be published');
