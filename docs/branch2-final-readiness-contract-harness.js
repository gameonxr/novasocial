...
assert.strictEqual(allDocs.length, 156, '156 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 156, '156 harness files must be published');
assert.strictEqual(contractFiles.length, 154, '154 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 153, '153 standard contract harnesses must be published');
