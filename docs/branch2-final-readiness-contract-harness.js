...
assert.strictEqual(allDocs.length, 224, '224 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 224, '224 harness files must be published');
assert.strictEqual(contractFiles.length, 222, '222 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 221, '221 standard contract harnesses must be published');
