...
assert.strictEqual(allDocs.length, 215, '215 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 215, '215 harness files must be published');
assert.strictEqual(contractFiles.length, 213, '213 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 212, '212 standard contract harnesses must be published');
