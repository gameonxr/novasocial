...
assert.strictEqual(allDocs.length, 117, '117 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 117, '117 harness files must be published');
assert.strictEqual(contractFiles.length, 115, '115 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 114, '114 standard contract harnesses must be published');
