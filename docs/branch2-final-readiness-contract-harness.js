...
assert.strictEqual(allDocs.length, 150, '150 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 150, '150 harness files must be published');
assert.strictEqual(contractFiles.length, 148, '148 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 147, '147 standard contract harnesses must be published');
