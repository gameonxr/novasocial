...
assert.strictEqual(allDocs.length, 183, '183 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 183, '183 harness files must be published');
assert.strictEqual(contractFiles.length, 181, '181 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 180, '180 standard contract harnesses must be published');
