...
assert.strictEqual(allDocs.length, 256, '256 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 256, '256 harness files must be published');
assert.strictEqual(contractFiles.length, 254, '254 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 253, '253 standard contract harnesses must be published');
