...
assert.strictEqual(allDocs.length, 143, '143 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 143, '143 harness files must be published');
assert.strictEqual(contractFiles.length, 141, '141 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 140, '140 standard contract harnesses must be published');
