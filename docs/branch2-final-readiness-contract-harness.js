...
assert.strictEqual(allDocs.length, 163, '163 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 163, '163 harness files must be published');
assert.strictEqual(contractFiles.length, 161, '161 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 160, '160 standard contract harnesses must be published');
