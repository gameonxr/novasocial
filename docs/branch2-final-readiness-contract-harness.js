...
assert.strictEqual(allDocs.length, 153, '153 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 153, '153 harness files must be published');
assert.strictEqual(contractFiles.length, 151, '151 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 150, '150 standard contract harnesses must be published');
