...
assert.strictEqual(allDocs.length, 168, '168 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 168, '168 harness files must be published');
assert.strictEqual(contractFiles.length, 166, '166 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 165, '165 standard contract harnesses must be published');
