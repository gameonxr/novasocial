...
assert.strictEqual(allDocs.length, 133, '133 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 133, '133 harness files must be published');
assert.strictEqual(contractFiles.length, 131, '131 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 130, '130 standard contract harnesses must be published');
