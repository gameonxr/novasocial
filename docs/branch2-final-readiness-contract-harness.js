...
assert.strictEqual(allDocs.length, 146, '146 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 146, '146 harness files must be published');
assert.strictEqual(contractFiles.length, 144, '144 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 143, '143 standard contract harnesses must be published');
