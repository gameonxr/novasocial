...
assert.strictEqual(allDocs.length, 132, '132 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 132, '132 harness files must be published');
assert.strictEqual(contractFiles.length, 130, '130 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 129, '129 standard contract harnesses must be published');
