...
assert.strictEqual(allDocs.length, 219, '219 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 219, '219 harness files must be published');
assert.strictEqual(contractFiles.length, 217, '217 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 216, '216 standard contract harnesses must be published');
