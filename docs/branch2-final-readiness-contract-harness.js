...
assert.strictEqual(allDocs.length, 83, '83 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 83, '83 harness files must be published');
assert.strictEqual(contractFiles.length, 81, '81 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 80, '80 standard contract harnesses must be published');
