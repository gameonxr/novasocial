...
assert.strictEqual(allDocs.length, 237, '237 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 237, '237 harness files must be published');
assert.strictEqual(contractFiles.length, 235, '235 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 234, '234 standard contract harnesses must be published');
