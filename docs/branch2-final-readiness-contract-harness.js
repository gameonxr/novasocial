...
assert.strictEqual(allDocs.length, 136, '136 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 136, '136 harness files must be published');
assert.strictEqual(contractFiles.length, 134, '134 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 133, '133 standard contract harnesses must be published');
