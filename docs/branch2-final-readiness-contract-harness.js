...
assert.strictEqual(allDocs.length, 152, '152 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 152, '152 harness files must be published');
assert.strictEqual(contractFiles.length, 150, '150 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 149, '149 standard contract harnesses must be published');
