...
assert.strictEqual(allDocs.length, 255, '255 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 255, '255 harness files must be published');
assert.strictEqual(contractFiles.length, 253, '253 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 252, '252 standard contract harnesses must be published');
