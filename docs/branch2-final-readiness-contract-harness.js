...
assert.strictEqual(allDocs.length, 192, '192 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 192, '192 harness files must be published');
assert.strictEqual(contractFiles.length, 190, '190 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 189, '189 standard contract harnesses must be published');
