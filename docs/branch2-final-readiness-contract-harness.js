...
assert.strictEqual(allDocs.length, 248, '248 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 248, '248 harness files must be published');
assert.strictEqual(contractFiles.length, 246, '246 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 245, '245 standard contract harnesses must be published');
