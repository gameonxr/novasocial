...
assert.strictEqual(allDocs.length, 85, '85 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 85, '85 harness files must be published');
assert.strictEqual(contractFiles.length, 83, '83 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 82, '82 standard contract harnesses must be published');
