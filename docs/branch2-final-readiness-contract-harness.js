...
assert.strictEqual(allDocs.length, 139, '139 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 139, '139 harness files must be published');
assert.strictEqual(contractFiles.length, 137, '137 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 136, '136 standard contract harnesses must be published');
