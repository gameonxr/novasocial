...
assert.strictEqual(allDocs.length, 243, '243 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 243, '243 harness files must be published');
assert.strictEqual(contractFiles.length, 241, '241 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 240, '240 standard contract harnesses must be published');
