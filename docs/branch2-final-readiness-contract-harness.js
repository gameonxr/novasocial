...
assert.strictEqual(allDocs.length, 235, '235 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 235, '235 harness files must be published');
assert.strictEqual(contractFiles.length, 233, '233 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 232, '232 standard contract harnesses must be published');
