...
assert.strictEqual(allDocs.length, 188, '188 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 188, '188 harness files must be published');
assert.strictEqual(contractFiles.length, 186, '186 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 185, '185 standard contract harnesses must be published');
