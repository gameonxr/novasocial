...
assert.strictEqual(allDocs.length, 241, '241 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 241, '241 harness files must be published');
assert.strictEqual(contractFiles.length, 239, '239 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 238, '238 standard contract harnesses must be published');
