...
assert.strictEqual(allDocs.length, 122, '122 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 122, '122 harness files must be published');
assert.strictEqual(contractFiles.length, 120, '120 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 119, '119 standard contract harnesses must be published');
