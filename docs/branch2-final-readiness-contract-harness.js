...
assert.strictEqual(allDocs.length, 97, '97 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 97, '97 harness files must be published');
assert.strictEqual(contractFiles.length, 95, '95 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 94, '94 standard contract harnesses must be published');
