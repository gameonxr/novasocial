...
assert.strictEqual(allDocs.length, 95, '95 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 95, '95 harness files must be published');
assert.strictEqual(contractFiles.length, 93, '93 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 92, '92 standard contract harnesses must be published');
