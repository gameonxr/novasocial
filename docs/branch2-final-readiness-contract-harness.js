...
assert.strictEqual(allDocs.length, 73, '73 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 73, '73 harness files must be published');
assert.strictEqual(contractFiles.length, 71, '71 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 70, '70 standard contract harnesses must be published');
