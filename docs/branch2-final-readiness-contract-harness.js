...
assert.strictEqual(allDocs.length, 80, '80 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 80, '80 harness files must be published');
assert.strictEqual(contractFiles.length, 78, '78 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 77, '77 standard contract harnesses must be published');
