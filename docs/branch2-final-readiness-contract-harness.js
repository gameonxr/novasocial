...
assert.strictEqual(allDocs.length, 252, '252 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 252, '252 harness files must be published');
assert.strictEqual(contractFiles.length, 250, '250 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 249, '249 standard contract harnesses must be published');
