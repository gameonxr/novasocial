...
assert.strictEqual(allDocs.length, 100, '100 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 100, '100 harness files must be published');
assert.strictEqual(contractFiles.length, 98, '98 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 97, '97 standard contract harnesses must be published');
