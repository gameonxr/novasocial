...
assert.strictEqual(allDocs.length, 169, '169 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 169, '169 harness files must be published');
assert.strictEqual(contractFiles.length, 167, '167 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 166, '166 standard contract harnesses must be published');
