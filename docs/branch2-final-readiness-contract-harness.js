...
assert.strictEqual(allDocs.length, 282, '282 documentation Markdown files must be published after disappearing-options renderer contract checkpoint');
assert.strictEqual(allHarnesses.length, 283, '283 harness files must be published after disappearing-options renderer contract checkpoint');
assert.strictEqual(contractFiles.length, 279, '279 standard contract documents must be published after disappearing-options renderer contract checkpoint');
assert.strictEqual(harnessFiles.length, 278, '278 standard contract harnesses must be published after disappearing-options renderer contract checkpoint');
