...
assert.strictEqual(allDocs.length, 269, '269 documentation Markdown files must be published after toggleSVMute production split');
assert.strictEqual(allHarnesses.length, 270, '270 harness files must be published after toggleSVMute production split');
assert.strictEqual(contractFiles.length, 266, '266 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 265, '265 standard contract harnesses must be published');
