...
assert.strictEqual(allDocs.length, 230, '230 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 230, '230 harness files must be published');
assert.strictEqual(contractFiles.length, 228, '228 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 227, '227 standard contract harnesses must be published');
