...
assert.strictEqual(allDocs.length, 176, '176 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 176, '176 harness files must be published');
assert.strictEqual(contractFiles.length, 174, '174 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 173, '173 standard contract harnesses must be published');
