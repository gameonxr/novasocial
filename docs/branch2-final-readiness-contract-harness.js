...
assert.strictEqual(allDocs.length, 213, '213 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 213, '213 harness files must be published');
assert.strictEqual(contractFiles.length, 211, '211 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 210, '210 standard contract harnesses must be published');
