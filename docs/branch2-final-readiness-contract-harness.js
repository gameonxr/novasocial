...
assert.strictEqual(allDocs.length, 165, '165 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 165, '165 harness files must be published');
assert.strictEqual(contractFiles.length, 163, '163 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 162, '162 standard contract harnesses must be published');
