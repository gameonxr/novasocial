...
assert.strictEqual(allDocs.length, 89, '89 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 89, '89 harness files must be published');
assert.strictEqual(contractFiles.length, 87, '87 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 86, '86 standard contract harnesses must be published');
