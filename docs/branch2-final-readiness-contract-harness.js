...
assert.strictEqual(allDocs.length, 253, '253 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 253, '253 harness files must be published');
assert.strictEqual(contractFiles.length, 251, '251 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 250, '250 standard contract harnesses must be published');
