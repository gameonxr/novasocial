...
assert.strictEqual(allDocs.length, 234, '234 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 234, '234 harness files must be published');
assert.strictEqual(contractFiles.length, 232, '232 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 231, '231 standard contract harnesses must be published');
