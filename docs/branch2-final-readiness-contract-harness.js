...
assert.strictEqual(allDocs.length, 276, '276 documentation Markdown files must be published after Smart Replies classifier contract checkpoint');
assert.strictEqual(allHarnesses.length, 277, '277 harness files must be published after Smart Replies classifier contract checkpoint');
assert.strictEqual(contractFiles.length, 273, '273 standard contract documents must be published after Smart Replies classifier contract checkpoint');
assert.strictEqual(harnessFiles.length, 272, '272 standard contract harnesses must be published after Smart Replies classifier contract checkpoint');
