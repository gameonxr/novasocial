...
assert.strictEqual(allDocs.length, 218, '218 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 218, '218 harness files must be published');
assert.strictEqual(contractFiles.length, 216, '216 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 215, '215 standard contract harnesses must be published');
