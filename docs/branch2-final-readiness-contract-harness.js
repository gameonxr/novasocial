...
assert.strictEqual(allDocs.length, 281, '281 documentation Markdown files must be published after Like Effects wrapper contract checkpoint');
assert.strictEqual(allHarnesses.length, 282, '282 harness files must be published after Like Effects wrapper contract checkpoint');
assert.strictEqual(contractFiles.length, 278, '278 standard contract documents must be published after Like Effects wrapper contract checkpoint');
assert.strictEqual(harnessFiles.length, 277, '277 standard contract harnesses must be published after Like Effects wrapper contract checkpoint');
