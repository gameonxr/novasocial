...
assert.strictEqual(allDocs.length, 118, '118 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 118, '118 harness files must be published');
assert.strictEqual(contractFiles.length, 116, '116 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 115, '115 standard contract harnesses must be published');
