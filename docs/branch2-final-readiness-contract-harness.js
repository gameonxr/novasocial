...
assert.strictEqual(allDocs.length, 113, '113 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 113, '113 harness files must be published');
assert.strictEqual(contractFiles.length, 111, '111 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 110, '110 standard contract harnesses must be published');
