...
assert.strictEqual(allDocs.length, 110, '110 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 110, '110 harness files must be published');
assert.strictEqual(contractFiles.length, 108, '108 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 107, '107 standard contract harnesses must be published');
