...
assert.strictEqual(allDocs.length, 294, '294 documentation Markdown files must be published after the forward-message product decision contract checkpoint');
assert.strictEqual(allHarnesses.length, 295, '295 harness files must be published after the forward-message product decision contract checkpoint');
assert.strictEqual(contractFiles.length, 291, '291 standard contract documents must be published after the forward-message product decision contract checkpoint');
assert.strictEqual(harnessFiles.length, 290, '290 standard contract harnesses must be published after the forward-message product decision contract checkpoint');
