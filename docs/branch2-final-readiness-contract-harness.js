...
assert.strictEqual(allDocs.length, 177, '177 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 177, '177 harness files must be published');
assert.strictEqual(contractFiles.length, 175, '175 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 174, '174 standard contract harnesses must be published');
