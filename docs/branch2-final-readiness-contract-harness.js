...
assert.strictEqual(allDocs.length, 79, '79 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 79, '79 harness files must be published');
assert.strictEqual(contractFiles.length, 77, '77 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 76, '76 standard contract harnesses must be published');
