...
assert.strictEqual(allDocs.length, 199, '199 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 199, '199 harness files must be published');
assert.strictEqual(contractFiles.length, 197, '197 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 196, '196 standard contract harnesses must be published');
