...
assert.strictEqual(allDocs.length, 111, '111 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 111, '111 harness files must be published');
assert.strictEqual(contractFiles.length, 109, '109 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 108, '108 standard contract harnesses must be published');
