...
assert.strictEqual(allDocs.length, 99, '99 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 99, '99 harness files must be published');
assert.strictEqual(contractFiles.length, 97, '97 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 96, '96 standard contract harnesses must be published');
