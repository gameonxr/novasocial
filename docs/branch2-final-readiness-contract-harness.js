...
assert.strictEqual(allDocs.length, 182, '182 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 182, '182 harness files must be published');
assert.strictEqual(contractFiles.length, 180, '180 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 179, '179 standard contract harnesses must be published');
