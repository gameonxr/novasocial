...
assert.strictEqual(allDocs.length, 130, '130 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 130, '130 harness files must be published');
assert.strictEqual(contractFiles.length, 128, '128 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 127, '127 standard contract harnesses must be published');
