...
assert.strictEqual(allDocs.length, 225, '225 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 225, '225 harness files must be published');
assert.strictEqual(contractFiles.length, 223, '223 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 222, '222 standard contract harnesses must be published');
