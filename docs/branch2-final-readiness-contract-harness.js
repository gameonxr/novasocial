...
assert.strictEqual(allDocs.length, 268, '268 documentation Markdown files must be published after toggleSVMute production split');
assert.strictEqual(allHarnesses.length, 269, '269 harness files must be published after toggleSVMute production split');
assert.strictEqual(contractFiles.length, 265, '265 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 264, '264 standard contract harnesses must be published');
