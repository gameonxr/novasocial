...
assert.strictEqual(allDocs.length, 250, '250 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 250, '250 harness files must be published');
assert.strictEqual(contractFiles.length, 248, '248 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 247, '247 standard contract harnesses must be published');
