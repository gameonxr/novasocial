...
assert.strictEqual(allDocs.length, 189, '189 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 189, '189 harness files must be published');
assert.strictEqual(contractFiles.length, 187, '187 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 186, '186 standard contract harnesses must be published');
