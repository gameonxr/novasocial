...
assert.strictEqual(allDocs.length, 159, '159 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 159, '159 harness files must be published');
assert.strictEqual(contractFiles.length, 157, '157 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 156, '156 standard contract harnesses must be published');
