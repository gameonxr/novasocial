...
assert.strictEqual(allDocs.length, 236, '236 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 236, '236 harness files must be published');
assert.strictEqual(contractFiles.length, 234, '234 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 233, '233 standard contract harnesses must be published');
