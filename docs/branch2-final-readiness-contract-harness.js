...
assert.strictEqual(allDocs.length, 101, '101 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 101, '101 harness files must be published');
assert.strictEqual(contractFiles.length, 99, '99 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 98, '98 standard contract harnesses must be published');
