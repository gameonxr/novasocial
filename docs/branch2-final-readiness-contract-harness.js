...
assert.strictEqual(allDocs.length, 195, '195 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 195, '195 harness files must be published');
assert.strictEqual(contractFiles.length, 193, '193 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 192, '192 standard contract harnesses must be published');
