...
assert.strictEqual(allDocs.length, 92, '92 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 92, '92 harness files must be published');
assert.strictEqual(contractFiles.length, 90, '90 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 89, '89 standard contract harnesses must be published');
