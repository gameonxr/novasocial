...
assert.strictEqual(allDocs.length, 160, '160 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 160, '160 harness files must be published');
assert.strictEqual(contractFiles.length, 158, '158 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 157, '157 standard contract harnesses must be published');
