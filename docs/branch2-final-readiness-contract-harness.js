...
assert.strictEqual(allDocs.length, 137, '137 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 137, '137 harness files must be published');
assert.strictEqual(contractFiles.length, 135, '135 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 134, '134 standard contract harnesses must be published');
