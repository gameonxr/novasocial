...
assert.strictEqual(allDocs.length, 212, '212 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 212, '212 harness files must be published');
assert.strictEqual(contractFiles.length, 210, '210 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 209, '209 standard contract harnesses must be published');
