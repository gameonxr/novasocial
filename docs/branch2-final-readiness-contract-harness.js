...
assert.strictEqual(allDocs.length, 209, '209 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 209, '209 harness files must be published');
assert.strictEqual(contractFiles.length, 207, '207 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 206, '206 standard contract harnesses must be published');
