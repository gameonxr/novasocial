...
assert.strictEqual(allDocs.length, 283, '283 documentation Markdown files must be published after Add Members renderer contract checkpoint');
assert.strictEqual(allHarnesses.length, 284, '284 harness files must be published after Add Members renderer contract checkpoint');
assert.strictEqual(contractFiles.length, 280, '280 standard contract documents must be published after Add Members renderer contract checkpoint');
assert.strictEqual(harnessFiles.length, 279, '279 standard contract harnesses must be published after Add Members renderer contract checkpoint');
