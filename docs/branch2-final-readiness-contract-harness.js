...
assert.strictEqual(allDocs.length, 254, '254 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 254, '254 harness files must be published');
assert.strictEqual(contractFiles.length, 252, '252 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 251, '251 standard contract harnesses must be published');
