...
assert.strictEqual(allDocs.length, 151, '151 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 151, '151 harness files must be published');
assert.strictEqual(contractFiles.length, 149, '149 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 148, '148 standard contract harnesses must be published');
