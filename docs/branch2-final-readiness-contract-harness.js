...
assert.strictEqual(allDocs.length, 76, '76 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 76, '76 harness files must be published');
assert.strictEqual(contractFiles.length, 74, '74 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 73, '73 standard contract harnesses must be published');
