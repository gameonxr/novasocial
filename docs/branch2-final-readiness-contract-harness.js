...
assert.strictEqual(allDocs.length, 196, '196 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 196, '196 harness files must be published');
assert.strictEqual(contractFiles.length, 194, '194 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 193, '193 standard contract harnesses must be published');
