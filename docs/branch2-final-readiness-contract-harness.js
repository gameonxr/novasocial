...
assert.strictEqual(allDocs.length, 103, '103 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 103, '103 harness files must be published');
assert.strictEqual(contractFiles.length, 101, '101 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 100, '100 standard contract harnesses must be published');
