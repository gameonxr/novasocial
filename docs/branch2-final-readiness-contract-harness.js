...
assert.strictEqual(allDocs.length, 114, '114 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 114, '114 harness files must be published');
assert.strictEqual(contractFiles.length, 112, '112 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 111, '111 standard contract harnesses must be published');
