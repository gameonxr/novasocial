...
assert.strictEqual(allDocs.length, 125, '125 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 125, '125 harness files must be published');
assert.strictEqual(contractFiles.length, 123, '123 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 122, '122 standard contract harnesses must be published');
