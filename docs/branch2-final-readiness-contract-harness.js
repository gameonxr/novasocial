...
assert.strictEqual(allDocs.length, 158, '158 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 158, '158 harness files must be published');
assert.strictEqual(contractFiles.length, 156, '156 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 155, '155 standard contract harnesses must be published');
