...
assert.strictEqual(allDocs.length, 141, '141 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 141, '141 harness files must be published');
assert.strictEqual(contractFiles.length, 139, '139 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 138, '138 standard contract harnesses must be published');
