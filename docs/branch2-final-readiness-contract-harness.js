...
assert.strictEqual(allDocs.length, 222, '222 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 222, '222 harness files must be published');
assert.strictEqual(contractFiles.length, 220, '220 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 219, '219 standard contract harnesses must be published');
