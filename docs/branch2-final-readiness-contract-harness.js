...
assert.strictEqual(allDocs.length, 290, '290 documentation Markdown files must be published after Story text-controls contract checkpoint');
assert.strictEqual(allHarnesses.length, 291, '291 harness files must be published after Story text-controls contract checkpoint');
assert.strictEqual(contractFiles.length, 287, '287 standard contract documents must be published after Story text-controls contract checkpoint');
assert.strictEqual(harnessFiles.length, 286, '286 standard contract harnesses must be published after Story text-controls contract checkpoint');
