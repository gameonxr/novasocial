...
assert.strictEqual(allDocs.length, 293, '293 documentation Markdown files must be published after Story music controls contract checkpoint');
assert.strictEqual(allHarnesses.length, 294, '294 harness files must be published after Story music controls contract checkpoint');
assert.strictEqual(contractFiles.length, 290, '290 standard contract documents must be published after Story music controls contract checkpoint');
assert.strictEqual(harnessFiles.length, 289, '289 standard contract harnesses must be published after Story music controls contract checkpoint');
