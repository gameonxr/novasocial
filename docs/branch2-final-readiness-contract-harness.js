...
assert.strictEqual(allDocs.length, 116, '116 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 116, '116 harness files must be published');
assert.strictEqual(contractFiles.length, 114, '114 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 113, '113 standard contract harnesses must be published');
