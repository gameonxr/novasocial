...
assert.strictEqual(allDocs.length, 186, '186 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 186, '186 harness files must be published');
assert.strictEqual(contractFiles.length, 184, '184 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 183, '183 standard contract harnesses must be published');
