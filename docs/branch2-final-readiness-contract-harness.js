...
assert.strictEqual(allDocs.length, 242, '242 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 242, '242 harness files must be published');
assert.strictEqual(contractFiles.length, 240, '240 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 239, '239 standard contract harnesses must be published');
