...
assert.strictEqual(allDocs.length, 179, '179 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 179, '179 harness files must be published');
assert.strictEqual(contractFiles.length, 177, '177 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 176, '176 standard contract harnesses must be published');
