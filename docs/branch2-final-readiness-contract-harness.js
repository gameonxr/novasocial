...
assert.strictEqual(allDocs.length, 245, '245 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 245, '245 harness files must be published');
assert.strictEqual(contractFiles.length, 243, '243 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 242, '242 standard contract harnesses must be published');
