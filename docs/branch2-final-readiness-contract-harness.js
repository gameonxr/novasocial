...
assert.strictEqual(allDocs.length, 93, '93 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 93, '93 harness files must be published');
assert.strictEqual(contractFiles.length, 91, '91 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 90, '90 standard contract harnesses must be published');
