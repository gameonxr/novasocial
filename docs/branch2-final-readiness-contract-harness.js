...
assert.strictEqual(allDocs.length, 197, '197 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 197, '197 harness files must be published');
assert.strictEqual(contractFiles.length, 195, '195 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 194, '194 standard contract harnesses must be published');
