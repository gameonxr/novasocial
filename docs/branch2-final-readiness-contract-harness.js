...
assert.strictEqual(allDocs.length, 104, '104 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 104, '104 harness files must be published');
assert.strictEqual(contractFiles.length, 102, '102 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 101, '101 standard contract harnesses must be published');
