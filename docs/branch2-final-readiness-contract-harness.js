...
assert.strictEqual(allDocs.length, 138, '138 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 138, '138 harness files must be published');
assert.strictEqual(contractFiles.length, 136, '136 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 135, '135 standard contract harnesses must be published');
