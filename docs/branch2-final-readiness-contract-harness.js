...
assert.strictEqual(allDocs.length, 198, '198 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 198, '198 harness files must be published');
assert.strictEqual(contractFiles.length, 196, '196 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 195, '195 standard contract harnesses must be published');
