...
assert.strictEqual(allDocs.length, 84, '84 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 84, '84 harness files must be published');
assert.strictEqual(contractFiles.length, 82, '82 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 81, '81 standard contract harnesses must be published');
