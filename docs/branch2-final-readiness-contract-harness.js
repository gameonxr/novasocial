...
assert.strictEqual(allDocs.length, 217, '217 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 217, '217 harness files must be published');
assert.strictEqual(contractFiles.length, 215, '215 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 214, '214 standard contract harnesses must be published');
