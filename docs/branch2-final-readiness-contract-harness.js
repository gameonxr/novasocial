...
assert.strictEqual(allDocs.length, 98, '98 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 98, '98 harness files must be published');
assert.strictEqual(contractFiles.length, 96, '96 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 95, '95 standard contract harnesses must be published');
