...
assert.strictEqual(allDocs.length, 210, '210 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 210, '210 harness files must be published');
assert.strictEqual(contractFiles.length, 208, '208 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 207, '207 standard contract harnesses must be published');
