...
assert.strictEqual(allDocs.length, 166, '166 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 166, '166 harness files must be published');
assert.strictEqual(contractFiles.length, 164, '164 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 163, '163 standard contract harnesses must be published');
