...
assert.strictEqual(allDocs.length, 239, '239 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 239, '239 harness files must be published');
assert.strictEqual(contractFiles.length, 237, '237 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 236, '236 standard contract harnesses must be published');
