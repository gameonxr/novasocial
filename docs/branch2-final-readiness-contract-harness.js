...
assert.strictEqual(allDocs.length, 129, '129 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 129, '129 harness files must be published');
assert.strictEqual(contractFiles.length, 127, '127 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 126, '126 standard contract harnesses must be published');
