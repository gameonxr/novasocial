...
assert.strictEqual(allDocs.length, 171, '171 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 171, '171 harness files must be published');
assert.strictEqual(contractFiles.length, 169, '169 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 168, '168 standard contract harnesses must be published');
