...
assert.strictEqual(allDocs.length, 191, '191 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 191, '191 harness files must be published');
assert.strictEqual(contractFiles.length, 189, '189 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 188, '188 standard contract harnesses must be published');
