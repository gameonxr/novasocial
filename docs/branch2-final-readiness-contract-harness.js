...
assert.strictEqual(allDocs.length, 332, '332 documentation Markdown files must be published after the Push subscription production-authorization preparation');
