...
assert.strictEqual(allDocs.length, 203, '203 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 203, '203 harness files must be published');
assert.strictEqual(contractFiles.length, 201, '201 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 200, '200 standard contract harnesses must be published');
