...
assert.strictEqual(allDocs.length, 112, '112 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 112, '112 harness files must be published');
assert.strictEqual(contractFiles.length, 110, '110 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 109, '109 standard contract harnesses must be published');
