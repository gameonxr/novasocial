...
assert.strictEqual(allDocs.length, 142, '142 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 142, '142 harness files must be published');
assert.strictEqual(contractFiles.length, 140, '140 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 139, '139 standard contract harnesses must be published');
