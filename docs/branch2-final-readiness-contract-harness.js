...
assert.strictEqual(allDocs.length, 126, '126 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 126, '126 harness files must be published');
assert.strictEqual(contractFiles.length, 124, '124 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 123, '123 standard contract harnesses must be published');
