...
assert.strictEqual(allDocs.length, 244, '244 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 244, '244 harness files must be published');
assert.strictEqual(contractFiles.length, 242, '242 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 241, '241 standard contract harnesses must be published');
