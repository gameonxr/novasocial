...
assert.strictEqual(allDocs.length, 187, '187 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 187, '187 harness files must be published');
assert.strictEqual(contractFiles.length, 185, '185 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 184, '184 standard contract harnesses must be published');
