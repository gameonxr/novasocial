...
assert.strictEqual(allDocs.length, 208, '208 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 208, '208 harness files must be published');
assert.strictEqual(contractFiles.length, 206, '206 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 205, '205 standard contract harnesses must be published');
