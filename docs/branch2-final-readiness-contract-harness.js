...
assert.strictEqual(allDocs.length, 194, '194 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 194, '194 harness files must be published');
assert.strictEqual(contractFiles.length, 192, '192 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 191, '191 standard contract harnesses must be published');
