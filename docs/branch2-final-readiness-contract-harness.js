...
assert.strictEqual(allDocs.length, 149, '149 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 149, '149 harness files must be published');
assert.strictEqual(contractFiles.length, 147, '147 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 146, '146 standard contract harnesses must be published');
