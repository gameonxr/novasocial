...
assert.strictEqual(allDocs.length, 72, '72 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 72, '72 harness files must be published');
assert.strictEqual(contractFiles.length, 70, '70 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 69, '69 standard contract harnesses must be published');
