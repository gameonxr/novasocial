...
assert.strictEqual(allDocs.length, 96, '96 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 96, '96 harness files must be published');
assert.strictEqual(contractFiles.length, 94, '94 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 93, '93 standard contract harnesses must be published');
