...
assert.strictEqual(allDocs.length, 211, '211 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 211, '211 harness files must be published');
assert.strictEqual(contractFiles.length, 209, '209 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 208, '208 standard contract harnesses must be published');
