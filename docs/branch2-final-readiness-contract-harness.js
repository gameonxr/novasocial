...
assert.strictEqual(allDocs.length, 162, '162 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 162, '162 harness files must be published');
assert.strictEqual(contractFiles.length, 160, '160 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 159, '159 standard contract harnesses must be published');
