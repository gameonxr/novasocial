...
assert.strictEqual(allDocs.length, 105, '105 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 105, '105 harness files must be published');
assert.strictEqual(contractFiles.length, 103, '103 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 102, '102 standard contract harnesses must be published');
