...
assert.strictEqual(allDocs.length, 106, '106 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 106, '106 harness files must be published');
assert.strictEqual(contractFiles.length, 104, '104 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 103, '103 standard contract harnesses must be published');
