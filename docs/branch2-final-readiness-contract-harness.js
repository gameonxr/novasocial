...
assert.strictEqual(allDocs.length, 289, '289 documentation Markdown files must be published after Story draw-controls contract checkpoint');
assert.strictEqual(allHarnesses.length, 290, '290 harness files must be published after Story draw-controls contract checkpoint');
assert.strictEqual(contractFiles.length, 286, '286 standard contract documents must be published after Story draw-controls contract checkpoint');
assert.strictEqual(harnessFiles.length, 285, '285 standard contract harnesses must be published after Story draw-controls contract checkpoint');
