...
assert.strictEqual(allDocs.length, 157, '157 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 157, '157 harness files must be published');
assert.strictEqual(contractFiles.length, 155, '155 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 154, '154 standard contract harnesses must be published');
