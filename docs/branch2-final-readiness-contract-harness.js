...
assert.strictEqual(allDocs.length, 135, '135 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 135, '135 harness files must be published');
assert.strictEqual(contractFiles.length, 133, '133 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 132, '132 standard contract harnesses must be published');
