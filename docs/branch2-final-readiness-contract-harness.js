...
assert.strictEqual(allDocs.length, 201, '201 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 201, '201 harness files must be published');
assert.strictEqual(contractFiles.length, 199, '199 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 198, '198 standard contract harnesses must be published');
