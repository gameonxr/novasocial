...
assert.strictEqual(allDocs.length, 246, '246 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 246, '246 harness files must be published');
assert.strictEqual(contractFiles.length, 244, '244 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 243, '243 standard contract harnesses must be published');
