...
assert.strictEqual(allDocs.length, 131, '131 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 131, '131 harness files must be published');
assert.strictEqual(contractFiles.length, 129, '129 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 128, '128 standard contract harnesses must be published');
