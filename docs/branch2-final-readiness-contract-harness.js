...
assert.strictEqual(allDocs.length, 200, '200 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 200, '200 harness files must be published');
assert.strictEqual(contractFiles.length, 198, '198 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 197, '197 standard contract harnesses must be published');
