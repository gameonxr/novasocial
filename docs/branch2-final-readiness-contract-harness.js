...
assert.strictEqual(allDocs.length, 75, '75 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 75, '75 harness files must be published');
assert.strictEqual(contractFiles.length, 73, '73 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 72, '72 standard contract harnesses must be published');
