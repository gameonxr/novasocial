...
assert.strictEqual(allDocs.length, 145, '145 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 145, '145 harness files must be published');
assert.strictEqual(contractFiles.length, 143, '143 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 142, '142 standard contract harnesses must be published');
