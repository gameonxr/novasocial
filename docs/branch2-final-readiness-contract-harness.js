...
assert.strictEqual(allDocs.length, 284, '284 documentation Markdown files must be published after New-DM renderer contract checkpoint');
assert.strictEqual(allHarnesses.length, 285, '285 harness files must be published after New-DM renderer contract checkpoint');
assert.strictEqual(contractFiles.length, 281, '281 standard contract documents must be published after New-DM renderer contract checkpoint');
assert.strictEqual(harnessFiles.length, 280, '280 standard contract harnesses must be published after New-DM renderer contract checkpoint');
