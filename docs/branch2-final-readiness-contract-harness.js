...
assert.strictEqual(allDocs.length, 181, '181 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 181, '181 harness files must be published');
assert.strictEqual(contractFiles.length, 179, '179 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 178, '178 standard contract harnesses must be published');
