...
assert.strictEqual(allDocs.length, 107, '107 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 107, '107 harness files must be published');
assert.strictEqual(contractFiles.length, 105, '105 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 104, '104 standard contract harnesses must be published');
