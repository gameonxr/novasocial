...
assert.strictEqual(allDocs.length, 140, '140 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 140, '140 harness files must be published');
assert.strictEqual(contractFiles.length, 138, '138 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 137, '137 standard contract harnesses must be published');
