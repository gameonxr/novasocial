...
assert.strictEqual(allDocs.length, 202, '202 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 202, '202 harness files must be published');
assert.strictEqual(contractFiles.length, 200, '200 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 199, '199 standard contract harnesses must be published');
