...
assert.strictEqual(allDocs.length, 88, '88 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 88, '88 harness files must be published');
assert.strictEqual(contractFiles.length, 86, '86 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 85, '85 standard contract harnesses must be published');
