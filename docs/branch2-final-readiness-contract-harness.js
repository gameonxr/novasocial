...
assert.strictEqual(allDocs.length, 220, '220 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 220, '220 harness files must be published');
assert.strictEqual(contractFiles.length, 218, '218 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 217, '217 standard contract harnesses must be published');
