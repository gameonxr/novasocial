...
assert.strictEqual(allDocs.length, 170, '170 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 170, '170 harness files must be published');
assert.strictEqual(contractFiles.length, 168, '168 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 167, '167 standard contract harnesses must be published');
