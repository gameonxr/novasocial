...
assert.strictEqual(allDocs.length, 91, '91 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 91, '91 harness files must be published');
assert.strictEqual(contractFiles.length, 89, '89 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 88, '88 standard contract harnesses must be published');
