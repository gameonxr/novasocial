...
assert.strictEqual(allDocs.length, 214, '214 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 214, '214 harness files must be published');
assert.strictEqual(contractFiles.length, 212, '212 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 211, '211 standard contract harnesses must be published');
