...
assert.strictEqual(allDocs.length, 178, '178 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 178, '178 harness files must be published');
assert.strictEqual(contractFiles.length, 176, '176 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 175, '175 standard contract harnesses must be published');
