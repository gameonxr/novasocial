...
assert.strictEqual(allDocs.length, 340, '340 documentation Markdown files must be published after the dead v2 guard investigation publication (339 prior + the investigation report)');
...
assert.deepStrictEqual(allDocs.filter(file => !file.endsWith('-contract.md')).sort(), ['CODEBASE_HEALTH_AUDIT.md', 'DEAD_V2_GUARD_INVESTIGATION.md', 'blocking-contract-assessment.md', 'browser-smoke-baseline-2026-08-22.md', 'notes-reaction-owner-independent-authorization-addendum.md', 'notes-reaction-owner-production-authorization-addendum.md', 'notes-submission-owner-dependency-map.md', 'notes-submission-owner-independent-authorization-addendum.md', 'notes-submission-owner-production-authorization-addendum.md', 'protected-contract-coverage.md', 'push-force-resubscribe-owner-dependency-map.md', 'push-force-resubscribe-owner-independent-authorization-addendum.md', 'push-force-resubscribe-owner-production-authorization-addendum.md', 'push-permission-banner-owner-independent-authorization-addendum.md', 'push-permission-banner-owner-production-authorization-addendum.md', 'push-silent-resubscribe-owner-independent-authorization-addendum.md', 'push-silent-resubscribe-owner-production-authorization-addendum.md', 'push-subscription-owner-dependency-map.md', 'push-subscription-owner-independent-authorization-addendum.md', 'push-subscription-owner-production-authorization-addendum.md', 'reels-renderer-navigation-independent-authorization-addendum.md', 'reels-renderer-navigation-production-authorization-addendum.md'], 'nonstandard documentation exceptions must remain explicitly mapped');
