...
assert.strictEqual(allDocs.length, 204, '204 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 204, '204 harness files must be published');
assert.strictEqual(contractFiles.length, 202, '202 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 201, '201 standard contract harnesses must be published');
