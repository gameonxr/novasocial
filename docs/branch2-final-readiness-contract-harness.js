...
assert.strictEqual(allDocs.length, 228, '228 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 228, '228 harness files must be published');
assert.strictEqual(contractFiles.length, 226, '226 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 225, '225 standard contract harnesses must be published');
