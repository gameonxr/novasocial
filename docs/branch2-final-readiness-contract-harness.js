...
assert.strictEqual(allDocs.length, 161, '161 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 161, '161 harness files must be published');
assert.strictEqual(contractFiles.length, 159, '159 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 158, '158 standard contract harnesses must be published');
