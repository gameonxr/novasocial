...
assert.strictEqual(allDocs.length, 240, '240 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 240, '240 harness files must be published');
assert.strictEqual(contractFiles.length, 238, '238 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 237, '237 standard contract harnesses must be published');
