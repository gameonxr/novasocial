...
assert.strictEqual(allDocs.length, 70, '70 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 70, '70 harness files must be published');
