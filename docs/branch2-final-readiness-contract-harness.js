...
assert.strictEqual(allDocs.length, 144, '144 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 144, '144 harness files must be published');
assert.strictEqual(contractFiles.length, 142, '142 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 141, '141 standard contract harnesses must be published');
