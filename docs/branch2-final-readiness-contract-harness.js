...
assert.strictEqual(allDocs.length, 223, '223 documentation Markdown files must be published');
assert.strictEqual(allHarnesses.length, 223, '223 harness files must be published');
assert.strictEqual(contractFiles.length, 221, '221 standard contract documents must be published');
assert.strictEqual(harnessFiles.length, 220, '220 standard contract harnesses must be published');
