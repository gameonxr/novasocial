...
assert.strictEqual(allDocs.length, 278, '278 documentation Markdown files must be published after Settings Features renderer contract checkpoint');
assert.strictEqual(allHarnesses.length, 279, '279 harness files must be published after Settings Features renderer contract checkpoint');
assert.strictEqual(contractFiles.length, 275, '275 standard contract documents must be published after Settings Features renderer contract checkpoint');
assert.strictEqual(harnessFiles.length, 274, '274 standard contract harnesses must be published after Settings Features renderer contract checkpoint');
