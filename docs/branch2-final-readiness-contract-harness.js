...
assert.strictEqual(allDocs.length, 291, '291 documentation Markdown files must be published after Story text-panel controls contract checkpoint');
assert.strictEqual(allHarnesses.length, 292, '292 harness files must be published after Story text-panel controls contract checkpoint');
assert.strictEqual(contractFiles.length, 288, '288 standard contract documents must be published after Story text-panel controls contract checkpoint');
assert.strictEqual(harnessFiles.length, 287, '287 standard contract harnesses must be published after Story text-panel controls contract checkpoint');
