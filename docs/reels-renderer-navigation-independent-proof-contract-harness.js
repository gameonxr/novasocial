...
function runExtractionCandidateSimulation() {
  ...
  assert.strictEqual(sha(candidateHtml), '2cecde5c324cb8359c7ec966846d1abfbf351b477ce393cc9fc305571ea7052e', 'candidate HTML hash must remain pinned after the search-messages owner split');
  return {
