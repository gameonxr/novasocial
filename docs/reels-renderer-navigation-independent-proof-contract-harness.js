...
function runExtractionCandidateSimulation() {
  ...
  assert.strictEqual(sha(candidateHtml), '7ae9fa8b8c51bc001961968142cccc8a8d918c5657acdd5c440b902452084eb8', 'candidate HTML hash must remain pinned after the admin-tab-approvals owner split');
  return {
