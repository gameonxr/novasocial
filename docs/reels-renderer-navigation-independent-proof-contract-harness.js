...
function runExtractionCandidateSimulation() {
  ...
  assert.strictEqual(sha(candidateHtml), 'e5d007d9f5f6dc146f2110e4d15d45882b7328a33cef18f6a591ee8caf25db6f', 'candidate HTML hash must remain pinned after the moderator-recommend-ban owner split');
  return {
