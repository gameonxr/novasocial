...
assert.deepStrictEqual(trailing, ['src/features/smart-ranking.js', 'src/features/nova-init.js', 'src/features/spawn-like-particles.js', 'src/features/sync-local-deletion-fallback.js', 'src/features/like-effects.js'], 'final five scripts must preserve required order after two protected splits');
