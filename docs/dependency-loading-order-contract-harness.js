...
assert.deepStrictEqual(trailing, ['src/features/push-settings.js', 'src/features/admin-appeals-filter-owner.js', 'src/features/set-reports-filter-owner.js', 'src/features/toggle-sv-mute-owner.js', 'src/features/set-verify-filter-owner.js', 'src/features/refresh-profile-counts-owner.js', 'src/features/note-reactors-list-owner.js', 'src/features/note-viewer-owners.js', 'src/features/note-deletion-owner.js', 'src/features/story-editor-owners.js', 'src/features/reels-video-windowing.js', 'src/features/like-effects.js'], 'final twelve scripts must preserve required order after the toggleSVMute split');
