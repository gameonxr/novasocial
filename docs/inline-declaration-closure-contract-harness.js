...
assert.strictEqual(declarations.length, 166, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
