...
assert.strictEqual(declarations.length, 138, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
