...
assert.strictEqual(declarations.length, 211, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
