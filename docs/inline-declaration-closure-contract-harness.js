...
assert.strictEqual(declarations.length, 125, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
