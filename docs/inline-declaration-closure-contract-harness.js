...
assert.strictEqual(declarations.length, 14, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
