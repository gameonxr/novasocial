...
assert.strictEqual(declarations.length, 133, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
