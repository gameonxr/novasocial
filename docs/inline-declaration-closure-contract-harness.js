...
assert.strictEqual(declarations.length, 198, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
