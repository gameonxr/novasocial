...
assert.strictEqual(declarations.length, 10, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
