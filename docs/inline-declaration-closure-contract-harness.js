...
for (const name of protectedNames.filter(name => name !== 'submitNote' && name !== 'toggleRecording' && name !== 'createPeerConnection')) {
  if (name === 'reactToNote') {
