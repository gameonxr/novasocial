...
assert.strictEqual(declarations.length, 220, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
