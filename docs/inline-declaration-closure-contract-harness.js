...
assert.strictEqual(declarations.length, 101, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
