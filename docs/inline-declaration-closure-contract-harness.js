...
assert.strictEqual(declarations.length, 224, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
