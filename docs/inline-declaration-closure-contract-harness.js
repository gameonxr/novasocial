...
assert.strictEqual(declarations.length, 186, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
