...
assert.strictEqual(declarations.length, 51, 'inline application script must retain 228 function declarations after the Push permission banner owner split');
