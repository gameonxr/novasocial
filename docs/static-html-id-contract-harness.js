...
assert.strictEqual(ids.length, 111, 'static HTML ID inventory must reflect the approved protected owner groups after the Reels renderer split');
assert.strictEqual(counts.size, 111, 'static HTML IDs must remain unique');
