...
assert.strictEqual(ids.length, 58, 'static HTML ID inventory must reflect the approved protected owner groups after the Reels renderer split');
assert.strictEqual(counts.size, 58, 'static HTML IDs must remain unique');
