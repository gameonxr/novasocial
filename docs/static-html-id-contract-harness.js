...
assert.strictEqual(ids.length, 106, 'static HTML ID inventory must reflect the approved protected owner groups after the Reels renderer split');
assert.strictEqual(counts.size, 106, 'static HTML IDs must remain unique');
