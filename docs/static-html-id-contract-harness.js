...
assert.strictEqual(ids.length, 145, 'static HTML ID inventory must reflect the approved protected owner groups after the Reels renderer split');
assert.strictEqual(counts.size, 145, 'static HTML IDs must remain unique');
