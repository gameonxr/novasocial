...
| Documentation pairing | 236 Markdown docs and 236 harnesses exist, with 234 standard contract docs, 233 standard contract harnesses, and three mapped legacy exceptions | PASS |
