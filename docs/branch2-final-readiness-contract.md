...
| Documentation pairing | 154 Markdown docs and 154 harnesses exist, with 152 standard contract docs, 151 standard contract harnesses, and three mapped legacy exceptions | PASS |
