...
| Documentation pairing | 237 Markdown docs and 237 harnesses exist, with 235 standard contract docs, 234 standard contract harnesses, and three mapped legacy exceptions | PASS |
