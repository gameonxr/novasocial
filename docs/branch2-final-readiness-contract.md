...
| Documentation pairing | 161 Markdown docs and 161 harnesses exist, with 159 standard contract docs, 158 standard contract harnesses, and three mapped legacy exceptions | PASS |
