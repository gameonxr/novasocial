...
| Documentation pairing | 186 Markdown docs and 186 harnesses exist, with 184 standard contract docs, 183 standard contract harnesses, and three mapped legacy exceptions | PASS |
