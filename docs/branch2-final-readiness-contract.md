...
| Documentation pairing | 84 Markdown docs and 84 harnesses exist, with 82 standard contract docs, 81 standard contract harnesses, and three mapped legacy exceptions | PASS |
