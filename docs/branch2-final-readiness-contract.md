...
| Documentation pairing | 249 Markdown docs and 249 harnesses exist, with 247 standard contract docs, 246 standard contract harnesses, and three mapped legacy exceptions | PASS |
