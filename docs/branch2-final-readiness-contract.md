...
| Documentation pairing | 127 Markdown docs and 127 harnesses exist, with 125 standard contract docs, 124 standard contract harnesses, and three mapped legacy exceptions | PASS |
