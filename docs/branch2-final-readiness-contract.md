...
| Documentation pairing | 240 Markdown docs and 240 harnesses exist, with 238 standard contract docs, 237 standard contract harnesses, and three mapped legacy exceptions | PASS |
