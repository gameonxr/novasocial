...
| Documentation pairing | 251 Markdown docs and 251 harnesses exist, with 249 standard contract docs, 248 standard contract harnesses, and three mapped legacy exceptions | PASS |
