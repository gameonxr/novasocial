...
| Documentation pairing | 238 Markdown docs and 238 harnesses exist, with 236 standard contract docs, 235 standard contract harnesses, and three mapped legacy exceptions | PASS |
