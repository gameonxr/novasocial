...
| Documentation pairing | 187 Markdown docs and 187 harnesses exist, with 185 standard contract docs, 184 standard contract harnesses, and three mapped legacy exceptions | PASS |
