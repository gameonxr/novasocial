...
| Documentation pairing | 194 Markdown docs and 194 harnesses exist, with 192 standard contract docs, 191 standard contract harnesses, and three mapped legacy exceptions | PASS |
