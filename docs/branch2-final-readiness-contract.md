...
| Documentation pairing | 195 Markdown docs and 195 harnesses exist, with 193 standard contract docs, 192 standard contract harnesses, and three mapped legacy exceptions | PASS |
