...
| Documentation pairing | 196 Markdown docs and 196 harnesses exist, with 194 standard contract docs, 193 standard contract harnesses, and three mapped legacy exceptions | PASS |
