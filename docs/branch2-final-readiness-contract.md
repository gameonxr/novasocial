...
| Documentation pairing | 183 Markdown docs and 183 harnesses exist, with 181 standard contract docs, 180 standard contract harnesses, and three mapped legacy exceptions | PASS |
