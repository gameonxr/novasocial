...
| Documentation pairing | 98 Markdown docs and 98 harnesses exist, with 96 standard contract docs, 95 standard contract harnesses, and three mapped legacy exceptions | PASS |
