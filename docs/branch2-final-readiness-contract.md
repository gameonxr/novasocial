...
| Documentation pairing | 149 Markdown docs and 149 harnesses exist, with 147 standard contract docs, 146 standard contract harnesses, and three mapped legacy exceptions | PASS |
