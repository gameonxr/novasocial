...
| Documentation pairing | 184 Markdown docs and 184 harnesses exist, with 182 standard contract docs, 181 standard contract harnesses, and three mapped legacy exceptions | PASS |
