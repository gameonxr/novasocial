...
| Documentation pairing | 254 Markdown docs and 254 harnesses exist, with 252 standard contract docs, 251 standard contract harnesses, and three mapped legacy exceptions | PASS |
