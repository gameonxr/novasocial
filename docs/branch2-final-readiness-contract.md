...
| Documentation pairing | 174 Markdown docs and 174 harnesses exist, with 172 standard contract docs, 171 standard contract harnesses, and three mapped legacy exceptions | PASS |
