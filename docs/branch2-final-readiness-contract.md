...
| Documentation pairing | 176 Markdown docs and 176 harnesses exist, with 174 standard contract docs, 173 standard contract harnesses, and three mapped legacy exceptions | PASS |
