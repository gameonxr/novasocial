...
| Documentation pairing | 245 Markdown docs and 245 harnesses exist, with 243 standard contract docs, 242 standard contract harnesses, and three mapped legacy exceptions | PASS |
