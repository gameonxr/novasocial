...
| Documentation pairing | 159 Markdown docs and 159 harnesses exist, with 157 standard contract docs, 156 standard contract harnesses, and three mapped legacy exceptions | PASS |
