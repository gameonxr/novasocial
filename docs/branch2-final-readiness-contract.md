...
| Documentation pairing | 233 Markdown docs and 233 harnesses exist, with 231 standard contract docs, 230 standard contract harnesses, and three mapped legacy exceptions | PASS |
