...
| Documentation pairing | 193 Markdown docs and 193 harnesses exist, with 191 standard contract docs, 190 standard contract harnesses, and three mapped legacy exceptions | PASS |
