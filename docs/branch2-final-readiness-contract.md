...
| Documentation pairing | 89 Markdown docs and 89 harnesses exist, with 87 standard contract docs, 86 standard contract harnesses, and three mapped legacy exceptions | PASS |
