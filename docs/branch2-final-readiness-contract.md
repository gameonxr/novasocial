...
| Documentation pairing | 244 Markdown docs and 244 harnesses exist, with 242 standard contract docs, 241 standard contract harnesses, and three mapped legacy exceptions | PASS |
