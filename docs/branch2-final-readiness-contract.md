...
| Documentation pairing | 173 Markdown docs and 173 harnesses exist, with 171 standard contract docs, 170 standard contract harnesses, and three mapped legacy exceptions | PASS |
