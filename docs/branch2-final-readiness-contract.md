...
| Documentation pairing | 247 Markdown docs and 247 harnesses exist, with 245 standard contract docs, 244 standard contract harnesses, and three mapped legacy exceptions | PASS |
