...
| Documentation pairing | 144 Markdown docs and 144 harnesses exist, with 142 standard contract docs, 141 standard contract harnesses, and three mapped legacy exceptions | PASS |
