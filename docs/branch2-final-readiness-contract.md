...
| Documentation pairing | 255 Markdown docs and 255 harnesses exist, with 253 standard contract docs, 252 standard contract harnesses, and three mapped legacy exceptions | PASS |
