...
| Documentation pairing | 235 Markdown docs and 235 harnesses exist, with 233 standard contract docs, 232 standard contract harnesses, and three mapped legacy exceptions | PASS |
