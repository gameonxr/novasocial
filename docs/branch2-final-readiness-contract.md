...
| Documentation pairing | 256 Markdown docs and 256 harnesses exist, with 254 standard contract docs, 253 standard contract harnesses, and three mapped legacy exceptions | PASS |
