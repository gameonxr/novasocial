...
| Documentation pairing | 185 Markdown docs and 185 harnesses exist, with 183 standard contract docs, 182 standard contract harnesses, and three mapped legacy exceptions | PASS |
