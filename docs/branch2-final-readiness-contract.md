...
| Documentation pairing | 250 Markdown docs and 250 harnesses exist, with 248 standard contract docs, 247 standard contract harnesses, and three mapped legacy exceptions | PASS |
