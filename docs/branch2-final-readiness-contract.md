...
| Documentation pairing | 78 Markdown docs and 78 harnesses exist, with 76 standard contract docs, 75 standard contract harnesses, and three mapped legacy exceptions | PASS |
