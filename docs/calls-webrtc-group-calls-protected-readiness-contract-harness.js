...
const contractPath = path.join(repo, 'docs', 'calls-webrtc-group-calls-protected-readiness-contract.md');
...
console.log('CALLS_WEBRTC_GROUP_CALLS_PROTECTED_READINESS_HARNESS=PASS');
