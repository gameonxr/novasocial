...
assert.strictEqual(count(/<script\b/gi), 221, 'after-split opening script count must be 221 after Notes reactor-list split');
assert.strictEqual(count(/<\/script>/gi), 221, 'after-split closing script count must be 221 after Notes reactor-list split');
assert.strictEqual(count(/<script\s+src=/gi), 220, 'after-split external script count must be 220 after Notes reactor-list split');
