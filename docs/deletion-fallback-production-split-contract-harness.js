...
assert.strictEqual(count(/<script\b/gi), 231, 'after-split opening script count must be 230 after the DMs renderer split');
assert.strictEqual(count(/<\/script>/gi), 231, 'after-split closing script count must be 230 after the DMs renderer split');
assert.strictEqual(count(/<script\s+src=/gi), 230, 'after-split external script count must be 229 after the DMs renderer split');
