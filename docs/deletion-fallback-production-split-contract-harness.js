...
assert.strictEqual(count(/<script\b/gi), 225, 'after-split opening script count must be 225 after verification filter split');
assert.strictEqual(count(/<\/script>/gi), 225, 'after-split closing script count must be 225 after verification filter split');
assert.strictEqual(count(/<script\s+src=/gi), 224, 'after-split external script count must be 224 after verification filter split');
