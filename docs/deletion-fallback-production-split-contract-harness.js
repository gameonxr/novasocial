...
assert.strictEqual(count(/<script\b/gi), 267, 'after-split opening script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<\/script>/gi), 267, 'after-split closing script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<script\s+src=/gi), 266, 'after-split external script count must be 235 after the Notes submission split');
