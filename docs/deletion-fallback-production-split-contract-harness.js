...
assert.strictEqual(count(/<script\b/gi), 226, 'after-split opening script count must be 226 after toggleSVMute split');
assert.strictEqual(count(/<\/script>/gi), 226, 'after-split closing script count must be 226 after toggleSVMute split');
assert.strictEqual(count(/<script\s+src=/gi), 225, 'after-split external script count must be 225 after toggleSVMute split');
