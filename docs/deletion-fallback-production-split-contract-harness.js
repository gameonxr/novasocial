...
assert.strictEqual(count(/<script\b/gi), 233, 'after-split opening script count must be 230 after the DMs renderer split');
assert.strictEqual(count(/<\/script>/gi), 233, 'after-split closing script count must be 230 after the DMs renderer split');
assert.strictEqual(count(/<script\s+src=/gi), 232, 'after-split external script count must be 232 after the Push permission banner split');
