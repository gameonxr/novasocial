...
assert.strictEqual(count(/<script\b/gi), 288, 'after-split opening script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<\/script>/gi), 288, 'after-split closing script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<script\s+src=/gi), 287, 'after-split external script count must be 235 after the Notes submission split');
