...
assert.strictEqual(count(/<script\b/gi), 460, 'after-split opening script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<\/script>/gi), 460, 'after-split closing script count must be 236 after the Notes submission split');
assert.strictEqual(count(/<script\s+src=/gi), 459, 'after-split external script count must be 235 after the Notes submission split');
