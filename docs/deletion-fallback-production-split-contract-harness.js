...
assert.strictEqual(count(/<script\b/gi), 222, 'after-split opening script count must be 222 after admin appeals filter split');
assert.strictEqual(count(/<\/script>/gi), 222, 'after-split closing script count must be 222 after admin appeals filter split');
assert.strictEqual(count(/<script\s+src=/gi), 221, 'after-split external script count must be 221 after admin appeals filter split');
