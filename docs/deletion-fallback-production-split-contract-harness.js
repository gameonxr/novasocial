...
assert.strictEqual(count(/<script\b/gi), 223, 'after-split opening script count must be 223 after refresh profile counts split');
assert.strictEqual(count(/<\/script>/gi), 223, 'after-split closing script count must be 223 after refresh profile counts split');
assert.strictEqual(count(/<script\s+src=/gi), 222, 'after-split external script count must be 222 after refresh profile counts split');
