...
assert.strictEqual(count(/<script\b/gi), 228, 'after-split opening script count must be 228 after confirmCropPreview split');
assert.strictEqual(count(/<\/script>/gi), 228, 'after-split closing script count must be 228 after confirmCropPreview split');
assert.strictEqual(count(/<script\s+src=/gi), 227, 'after-split external script count must be 227 after confirmCropPreview split');
