...
assert.strictEqual(count(/<script\b/gi), 224, 'after-split opening script count must be 224 after reports filter split');
assert.strictEqual(count(/<\/script>/gi), 224, 'after-split closing script count must be 224 after reports filter split');
assert.strictEqual(count(/<script\s+src=/gi), 223, 'after-split external script count must be 223 after reports filter split');
