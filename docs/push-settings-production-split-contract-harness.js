...
assert.strictEqual((html.match(/<script\b/gi) || []).length, 220, '220 opening script tags required after Note deletion split');
assert.strictEqual((html.match(/<\/script>/gi) || []).length, 220, '220 closing script tags required after Note deletion split');
assert.strictEqual((html.match(/<script\s+src=/gi) || []).length, 219, '219 external script tags required after Note deletion split');
