...
| Protected production splits | 11/19 protected signatures moved or under final validation; one additional supporting Reels windowing helper is split with its own gate | Direct extraction remains blocked for the 8 unapproved protected signatures |
