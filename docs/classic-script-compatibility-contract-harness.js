...
assert.strictEqual(scriptTags.length, 362, 'index.html must retain 236 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 360, 'src must retain 233 extracted JavaScript files after the DMs renderer split');
