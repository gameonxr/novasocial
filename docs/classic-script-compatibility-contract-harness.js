...
assert.strictEqual(scriptTags.length, 220, 'index.html must retain 220 script tags after Reels windowing helper split');
...
assert.strictEqual(extractedFiles.length, 218, 'src must retain 218 extracted JavaScript files after Reels windowing helper split');
