...
assert.strictEqual(scriptTags.length, 233, 'index.html must retain 233 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 231, 'src must retain 228 extracted JavaScript files after the DMs renderer split');
