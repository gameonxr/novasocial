...
assert.strictEqual(scriptTags.length, 459, 'index.html must retain 236 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 457, 'src must retain 233 extracted JavaScript files after the DMs renderer split');
