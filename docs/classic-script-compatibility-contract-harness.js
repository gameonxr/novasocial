...
assert.strictEqual(scriptTags.length, 232, 'index.html must retain 232 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 230, 'src must retain 228 extracted JavaScript files after the DMs renderer split');
