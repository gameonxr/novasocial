...
assert.strictEqual(scriptTags.length, 442, 'index.html must retain 236 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 440, 'src must retain 233 extracted JavaScript files after the DMs renderer split');
