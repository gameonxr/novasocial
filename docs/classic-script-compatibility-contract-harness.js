...
assert.strictEqual(scriptTags.length, 340, 'index.html must retain 236 script tags after the DMs renderer split');
...
assert.strictEqual(extractedFiles.length, 338, 'src must retain 233 extracted JavaScript files after the DMs renderer split');
