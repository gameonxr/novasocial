...
assert.strictEqual(scriptTags.length, 214, 'index.html must retain 214 script tags');
...
assert.strictEqual(extractedFiles.length, 212, 'src must retain 212 extracted JavaScript files');
