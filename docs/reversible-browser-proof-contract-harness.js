...
assert(matrix.includes('Protected production splits | 11/19 protected signatures moved or under final validation; one additional supporting Reels windowing helper is split with its own gate'), 'matrix must report the ten moved protected signatures and supporting Reels helper');
