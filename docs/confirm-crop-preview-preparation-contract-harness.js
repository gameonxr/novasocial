...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 228 : 364, 'source module count must match the current post-split candidate state for Notes submission');
