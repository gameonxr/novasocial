...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 228 : 461, 'source module count must match the current post-split candidate state for Notes submission');
