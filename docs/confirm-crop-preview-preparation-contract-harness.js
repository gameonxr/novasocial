...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 228 : 300, 'source module count must match the current post-split candidate state for Notes submission');
