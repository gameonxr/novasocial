...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 226 : 227, 'source module count must match the pre/post-split candidate state after the jump-to-message split');
