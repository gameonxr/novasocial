...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 227 : 228, 'source module count must match the pre/post-split candidate state after the DMs renderer split');
