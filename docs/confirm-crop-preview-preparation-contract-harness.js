...
assert.strictEqual(sourceFiles.length, hasInlineOwner ? 228 : 231, 'source module count must match the pre/post-split candidate state after the DMs renderer split');
