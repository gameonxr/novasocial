...
assert.strictEqual(files.length, 380, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 550, 'top-level function inventory must reflect the adminTabDashboard owner extraction');
