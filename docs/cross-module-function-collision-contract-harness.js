...
assert.strictEqual(files.length, 319, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 611, 'top-level function inventory must reflect the showAppealForm owner extraction');
