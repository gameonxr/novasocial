...
assert.strictEqual(files.length, 408, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 522, 'top-level function inventory must reflect the adminRejectAppeal owner extraction');
