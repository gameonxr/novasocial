...
assert.strictEqual(files.length, 324, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 606, 'top-level function inventory must reflect the _updateMessageReactionInPlace owner extraction');
