...
assert.strictEqual(files.length, 367, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 563, 'top-level function inventory must reflect the createGC owner extraction');
