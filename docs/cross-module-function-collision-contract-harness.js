...
assert.strictEqual(files.length, 424, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 506, 'top-level function inventory must reflect the blockUser owner extraction');
