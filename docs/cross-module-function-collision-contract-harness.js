...
assert.strictEqual(files.length, 353, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 577, 'top-level function inventory must reflect the svAppendOverlays owner extraction');
