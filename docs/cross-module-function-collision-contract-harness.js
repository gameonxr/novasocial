...
assert.strictEqual(files.length, 329, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 601, 'top-level function inventory must reflect the sendStoryReply owner extraction');
