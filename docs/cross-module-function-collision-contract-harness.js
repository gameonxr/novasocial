...
assert.strictEqual(files.length, 443, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 487, 'top-level function inventory must reflect the renderSV owner extraction');
