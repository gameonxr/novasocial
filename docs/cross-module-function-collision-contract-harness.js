...
assert.strictEqual(files.length, 345, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 585, 'top-level function inventory must reflect the _loadOlderMessages owner extraction');
