...
assert.strictEqual(files.length, 411, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 519, 'top-level function inventory must reflect the loadAdminContent owner extraction');
