...
assert.strictEqual(files.length, 368, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 562, 'top-level function inventory must reflect the searchAddMembers owner extraction');
