...
assert.strictEqual(files.length, 249, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 681, 'top-level function inventory must reflect the createIncomingCallBanner owner extraction');
