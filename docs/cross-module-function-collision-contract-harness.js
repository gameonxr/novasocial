...
assert.strictEqual(files.length, 401, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 529, 'top-level function inventory must reflect the showAdminUserDetail owner extraction');
