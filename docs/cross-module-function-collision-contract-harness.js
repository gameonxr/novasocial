...
assert.strictEqual(files.length, 378, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 552, 'top-level function inventory must reflect the sendGif owner extraction');
