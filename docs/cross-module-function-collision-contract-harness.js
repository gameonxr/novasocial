...
assert.strictEqual(files.length, 327, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 603, 'top-level function inventory must reflect the listenForSignals owner extraction');
