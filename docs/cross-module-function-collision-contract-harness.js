...
assert.strictEqual(files.length, 410, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 520, 'top-level function inventory must reflect the adminTabContent owner extraction');
