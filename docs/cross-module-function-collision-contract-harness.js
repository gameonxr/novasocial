...
assert.strictEqual(files.length, 323, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 607, 'top-level function inventory must reflect the showGroupCallScreen owner extraction');
