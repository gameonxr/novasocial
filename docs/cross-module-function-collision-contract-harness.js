...
assert.strictEqual(files.length, 309, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 621, 'top-level function inventory must reflect the adminDemoteModerator owner extraction');
