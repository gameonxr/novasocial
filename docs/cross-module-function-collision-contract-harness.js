...
assert.strictEqual(files.length, 297, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 633, 'top-level function inventory must reflect the addToGroup owner extraction');
