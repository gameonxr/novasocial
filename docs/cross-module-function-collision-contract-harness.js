...
assert.strictEqual(files.length, 427, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 503, 'top-level function inventory must reflect the stopNetworkMonitor owner extraction');
