...
assert.strictEqual(files.length, 307, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 623, 'top-level function inventory must reflect the adminBanMsgUser owner extraction');
