...
assert.strictEqual(files.length, 347, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 583, 'top-level function inventory must reflect the showReportDetail owner extraction');
