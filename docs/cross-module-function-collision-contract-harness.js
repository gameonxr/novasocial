...
assert.strictEqual(files.length, 361, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 569, 'top-level function inventory must reflect the searchGC owner extraction');
