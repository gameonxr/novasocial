...
assert.strictEqual(files.length, 325, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 605, 'top-level function inventory must reflect the leaveGroupCall owner extraction');
