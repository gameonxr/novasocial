...
assert.strictEqual(files.length, 275, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 655, 'top-level function inventory must reflect the toggleGroupMute owner extraction');
