...
assert.strictEqual(files.length, 274, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 656, 'top-level function inventory must reflect the updateCallStatus owner extraction');
