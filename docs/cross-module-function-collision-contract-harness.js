...
assert.strictEqual(files.length, 379, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 551, 'top-level function inventory must reflect the uploadCustomSticker owner extraction');
