...
assert.strictEqual(files.length, 425, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 505, 'top-level function inventory must reflect the unblockUser owner extraction');
