...
assert.strictEqual(files.length, 355, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 575, 'top-level function inventory must reflect the doSearchMessages owner extraction');
