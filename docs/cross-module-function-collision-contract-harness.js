...
assert.strictEqual(files.length, 241, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 689, 'top-level function inventory must reflect the cleanupExpiredStoryMedia owner extraction');
