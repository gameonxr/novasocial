...
assert.strictEqual(files.length, 331, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 599, 'top-level function inventory must reflect the createGroupPeerConnection owner extraction');
