...
assert.strictEqual(files.length, 283, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 647, 'top-level function inventory must reflect the adminDismissReport owner extraction');
