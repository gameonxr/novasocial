...
assert.strictEqual(files.length, 341, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 589, 'top-level function inventory must reflect the swipeEnd owner extraction');
