...
assert.strictEqual(files.length, 346, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 584, 'top-level function inventory must reflect the showGroupInfo owner extraction');
