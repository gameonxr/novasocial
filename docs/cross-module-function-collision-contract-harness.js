...
assert.strictEqual(files.length, 351, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 579, 'top-level function inventory must reflect the switchReelsView owner extraction');
