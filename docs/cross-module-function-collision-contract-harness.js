...
assert.strictEqual(files.length, 295, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 635, 'top-level function inventory must reflect the showCallMoreMenu owner extraction');
