...
assert.strictEqual(files.length, 356, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 574, 'top-level function inventory must reflect the toggleFollowProfile owner extraction');
