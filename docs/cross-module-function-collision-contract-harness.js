...
assert.strictEqual(files.length, 335, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 595, 'top-level function inventory must reflect the initFabSystem owner extraction');
