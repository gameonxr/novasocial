...
assert.strictEqual(files.length, 388, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 542, 'top-level function inventory must reflect the deleteStory owner extraction');
