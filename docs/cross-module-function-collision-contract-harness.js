...
assert.strictEqual(files.length, 431, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 499, 'top-level function inventory must reflect the stopRingtone owner extraction');
