...
assert.strictEqual(files.length, 441, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 489, 'top-level function inventory must reflect the showDeleteZone owner extraction');
