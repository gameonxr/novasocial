...
assert.strictEqual(files.length, 374, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 556, 'top-level function inventory must reflect the adminRejectVerify owner extraction');
