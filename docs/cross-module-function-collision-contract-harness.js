...
assert.strictEqual(files.length, 251, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 679, 'top-level function inventory must reflect the checkUserActiveNote owner extraction');
