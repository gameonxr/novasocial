...
assert.strictEqual(files.length, 292, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 638, 'top-level function inventory must reflect the listenForGroupParticipants owner extraction');
