...
assert.strictEqual(files.length, 266, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 664, 'top-level function inventory must reflect the minimizeCall owner extraction');
