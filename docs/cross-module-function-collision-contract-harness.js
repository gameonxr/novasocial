...
assert.strictEqual(files.length, 291, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 639, 'top-level function inventory must reflect the createOfferToParticipant owner extraction');
