...
assert.strictEqual(files.length, 328, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 602, 'top-level function inventory must reflect the listenForGroupSignals owner extraction');
