...
assert.strictEqual(files.length, 290, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 640, 'top-level function inventory must reflect the listenForCallStatus owner extraction');
