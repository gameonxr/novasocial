...
assert.strictEqual(files.length, 282, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 648, 'top-level function inventory must reflect the toggleApprovalSystem owner extraction');
