...
assert.strictEqual(files.length, 337, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 593, 'top-level function inventory must reflect the setChatTheme owner extraction');
