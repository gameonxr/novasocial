...
assert.strictEqual(files.length, 457, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 474, 'top-level function inventory must reflect the loadMsgs whitespace normalization');
