...
assert.strictEqual(files.length, 454, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 477, 'top-level function inventory must reflect the loadMsgs whitespace normalization');
