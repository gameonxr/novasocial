...
assert.strictEqual(files.length, 312, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 618, 'top-level function inventory must reflect the _showNewMessagePill owner extraction');
