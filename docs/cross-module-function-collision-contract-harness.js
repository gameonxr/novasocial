...
assert.strictEqual(files.length, 336, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 594, 'top-level function inventory must reflect the searchAddMember owner extraction');
