...
assert.strictEqual(files.length, 326, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 604, 'top-level function inventory must reflect the uploadGCAvatar owner extraction');
