...
assert.strictEqual(files.length, 344, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 586, 'top-level function inventory must reflect the applyMoodToFeed owner extraction');
