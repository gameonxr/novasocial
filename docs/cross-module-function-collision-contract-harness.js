...
assert.strictEqual(files.length, 433, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 497, 'top-level function inventory must reflect the startBanRecheck owner extraction');
