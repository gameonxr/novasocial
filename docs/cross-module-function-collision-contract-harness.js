...
assert.strictEqual(files.length, 418, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 512, 'top-level function inventory must reflect the searchUserForPromotion owner extraction');
