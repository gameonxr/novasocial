...
assert.strictEqual(files.length, 242, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 688, 'top-level function inventory must reflect the resetAccountScopedUiState owner extraction');
