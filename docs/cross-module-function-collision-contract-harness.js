...
assert.strictEqual(files.length, 404, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 526, 'top-level function inventory must reflect the loadVerifyList owner extraction');
