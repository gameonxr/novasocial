...
assert.strictEqual(files.length, 442, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 488, 'top-level function inventory must reflect the hideDeleteZone owner extraction');
