...
assert.strictEqual(files.length, 453, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 478, 'top-level function inventory must reflect the loadMsgs whitespace normalization');
