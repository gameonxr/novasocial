...
assert.strictEqual(files.length, 372, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 558, 'top-level function inventory must reflect the goBack owner extraction');
