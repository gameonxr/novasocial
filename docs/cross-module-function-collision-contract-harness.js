...
assert.strictEqual(files.length, 293, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 637, 'top-level function inventory must reflect the adminUnbanMsgUser owner extraction');
