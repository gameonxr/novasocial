...
assert.strictEqual(files.length, 259, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 671, 'top-level function inventory must reflect the rejectIncomingCall owner extraction');
