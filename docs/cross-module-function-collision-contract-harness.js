...
assert.strictEqual(files.length, 389, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 541, 'top-level function inventory must reflect the _silentBackgroundRefresh owner extraction');
