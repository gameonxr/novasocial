...
assert.strictEqual(files.length, 311, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 619, 'top-level function inventory must reflect the _instantCloudinaryDelete owner extraction');
