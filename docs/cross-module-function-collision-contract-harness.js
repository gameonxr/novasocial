...
assert.strictEqual(files.length, 281, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 649, 'top-level function inventory must reflect the playRingtone owner extraction');
