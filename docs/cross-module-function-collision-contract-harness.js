...
assert.strictEqual(files.length, 417, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 513, 'top-level function inventory must reflect the loadTeamList owner extraction');
