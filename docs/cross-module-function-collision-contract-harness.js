...
assert.strictEqual(files.length, 277, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 653, 'top-level function inventory must reflect the nextSV owner extraction');
