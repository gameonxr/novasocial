...
assert.strictEqual(files.length, 375, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 555, 'top-level function inventory must reflect the adminPromoteModerator owner extraction');
