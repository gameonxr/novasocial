...
assert.strictEqual(files.length, 280, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 650, 'top-level function inventory must reflect the heartReact owner extraction');
