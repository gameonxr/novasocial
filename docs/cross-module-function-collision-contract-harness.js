...
assert.strictEqual(files.length, 271, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 659, 'top-level function inventory must reflect the showGroupCallTypeMenu owner extraction');
