...
assert.strictEqual(files.length, 432, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 498, 'top-level function inventory must reflect the openCropPreview owner extraction');
