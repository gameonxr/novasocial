...
assert.strictEqual(files.length, 393, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 537, 'top-level function inventory must reflect the sendMediaMsg owner extraction');
