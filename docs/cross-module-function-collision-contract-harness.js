...
assert.strictEqual(files.length, 300, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 630, 'top-level function inventory must reflect the handleIncomingCall owner extraction');
