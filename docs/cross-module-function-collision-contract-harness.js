...
assert.strictEqual(files.length, 318, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 612, 'top-level function inventory must reflect the joinGroupCall owner extraction');
