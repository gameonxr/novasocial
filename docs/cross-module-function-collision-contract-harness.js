...
assert.strictEqual(files.length, 381, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 549, 'top-level function inventory must reflect the adminPromoteModToAdmin owner extraction');
