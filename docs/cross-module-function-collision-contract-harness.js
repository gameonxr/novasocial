...
assert.strictEqual(files.length, 332, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 598, 'top-level function inventory must reflect the autoPurgeExpiredSoftDeletes owner extraction');
