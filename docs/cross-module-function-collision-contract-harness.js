...
assert.strictEqual(files.length, 265, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 665, 'top-level function inventory must reflect the toggleGroupVideo owner extraction');
