...
assert.strictEqual(files.length, 407, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 523, 'top-level function inventory must reflect the adminApproveAppeal owner extraction');
