...
assert.strictEqual(files.length, 316, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 614, 'top-level function inventory must reflect the submitBanAppeal owner extraction');
