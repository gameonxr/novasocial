...
assert.strictEqual(files.length, 438, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 492, 'top-level function inventory must reflect the refreshPollResults owner extraction');
