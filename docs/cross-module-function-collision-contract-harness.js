...
assert.strictEqual(files.length, 315, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 615, 'top-level function inventory must reflect the adminDemoteUser owner extraction');
