...
assert.strictEqual(files.length, 294, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 636, 'top-level function inventory must reflect the enableCallPiP owner extraction');
