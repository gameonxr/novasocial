...
assert.strictEqual(files.length, 412, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 518, 'top-level function inventory must reflect the adminDeleteAnyContent owner extraction');
