...
assert.strictEqual(files.length, 302, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 628, 'top-level function inventory must reflect the makeAdmin owner extraction');
