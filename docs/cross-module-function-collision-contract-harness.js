...
assert.strictEqual(files.length, 352, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 578, 'top-level function inventory must reflect the _setupCropDragHandlers owner extraction');
