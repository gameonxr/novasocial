...
assert.strictEqual(files.length, 444, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 486, 'top-level function inventory must reflect the openSV owner extraction');
