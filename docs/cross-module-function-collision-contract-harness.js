...
assert.strictEqual(files.length, 313, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 617, 'top-level function inventory must reflect the deleteConversationMedia owner extraction');
