...
assert.strictEqual(files.length, 354, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 576, 'top-level function inventory must reflect the switchCallCamera owner extraction');
