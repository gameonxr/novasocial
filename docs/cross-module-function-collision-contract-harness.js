...
assert.strictEqual(files.length, 273, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 657, 'top-level function inventory must reflect the setupWebRTCCaller owner extraction');
