...
assert.strictEqual(files.length, 369, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 561, 'top-level function inventory must reflect the showEmergencyLockScreen owner extraction');
