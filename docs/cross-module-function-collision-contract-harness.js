...
assert.strictEqual(files.length, 426, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 504, 'top-level function inventory must reflect the startNetworkMonitor owner extraction');
