...
assert.strictEqual(files.length, 416, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 514, 'top-level function inventory must reflect the loadAdminDeletedPosts owner extraction');
