...
assert.strictEqual(files.length, 296, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 634, 'top-level function inventory must reflect the swipeMove owner extraction');
