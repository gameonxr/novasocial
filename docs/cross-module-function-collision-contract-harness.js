...
assert.strictEqual(files.length, 366, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 564, 'top-level function inventory must reflect the reactMsg owner extraction');
