...
assert.strictEqual(files.length, 445, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 485, 'top-level function inventory must reflect the _saveTabToCache owner extraction');
