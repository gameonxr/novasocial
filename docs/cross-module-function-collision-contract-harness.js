...
assert.strictEqual(files.length, 415, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 515, 'top-level function inventory must reflect the adminRecoverPost owner extraction');
