...
assert.strictEqual(files.length, 248, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 682, 'top-level function inventory must reflect the setTyping owner extraction');
