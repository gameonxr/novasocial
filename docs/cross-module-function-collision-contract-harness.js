...
assert.strictEqual(files.length, 255, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 675, 'top-level function inventory must reflect the updateParticipantCount owner extraction');
