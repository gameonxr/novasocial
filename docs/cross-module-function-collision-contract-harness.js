...
assert.strictEqual(files.length, 317, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 613, 'top-level function inventory must reflect the initiateGroupCall owner extraction');
