...
assert.strictEqual(files.length, 373, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 557, 'top-level function inventory must reflect the shareLocation owner extraction');
