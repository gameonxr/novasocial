...
assert.strictEqual(files.length, 308, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 622, 'top-level function inventory must reflect the initiateCall owner extraction');
