...
assert.strictEqual(files.length, 246, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 684, 'top-level function inventory must reflect the showAdminPanel owner extraction');
