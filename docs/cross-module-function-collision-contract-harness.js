...
assert.strictEqual(files.length, 260, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 670, 'top-level function inventory must reflect the toggleCallMute owner extraction');
