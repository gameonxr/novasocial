...
assert.strictEqual(files.length, 423, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 507, 'top-level function inventory must reflect the novaDebug owner extraction');
