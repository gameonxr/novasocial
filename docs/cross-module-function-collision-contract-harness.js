...
assert.strictEqual(files.length, 430, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 500, 'top-level function inventory must reflect the showCallScreen owner extraction');
