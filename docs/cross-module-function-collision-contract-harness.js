...
assert.strictEqual(files.length, 330, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 600, 'top-level function inventory must reflect the adminBanUser owner extraction');
