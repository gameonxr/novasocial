...
assert.strictEqual(files.length, 258, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 672, 'top-level function inventory must reflect the swipeStart owner extraction');
