...
assert.strictEqual(files.length, 276, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 654, 'top-level function inventory must reflect the stopSVPlayback owner extraction');
