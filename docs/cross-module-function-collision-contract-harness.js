...
assert.strictEqual(files.length, 419, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 511, 'top-level function inventory must reflect the showStaffActions owner extraction');
