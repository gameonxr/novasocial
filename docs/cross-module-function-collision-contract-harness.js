...
assert.strictEqual(files.length, 267, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 663, 'top-level function inventory must reflect the restoreCall owner extraction');
