...
assert.strictEqual(files.length, 437, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 493, 'top-level function inventory must reflect the voteStoryPoll owner extraction');
