...
assert.strictEqual(files.length, 342, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 588, 'top-level function inventory must reflect the muteGroup owner extraction');
