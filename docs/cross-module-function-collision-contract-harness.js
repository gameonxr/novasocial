...
assert.strictEqual(files.length, 422, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 508, 'top-level function inventory must reflect the adminTabMyApprovals owner extraction');
