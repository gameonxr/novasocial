...
assert.strictEqual(files.length, 268, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 662, 'top-level function inventory must reflect the nextUserSV owner extraction');
