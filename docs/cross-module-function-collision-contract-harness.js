...
assert.strictEqual(files.length, 370, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 560, 'top-level function inventory must reflect the checkEmergencyLock owner extraction');
