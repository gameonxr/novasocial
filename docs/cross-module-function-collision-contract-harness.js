...
assert.strictEqual(files.length, 387, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 543, 'top-level function inventory must reflect the showCallHistory owner extraction');
