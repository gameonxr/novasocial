...
assert.strictEqual(files.length, 364, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 566, 'top-level function inventory must reflect the setupPostsRealtime owner extraction');
