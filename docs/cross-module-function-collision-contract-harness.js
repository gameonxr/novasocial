...
assert.strictEqual(files.length, 343, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 587, 'top-level function inventory must reflect the pickStoryMedia owner extraction');
