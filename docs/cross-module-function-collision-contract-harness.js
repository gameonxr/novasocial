...
assert.strictEqual(files.length, 240, 'index.html plus 239 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 690, 'top-level function inventory must reflect the removeAccountSession owner extraction');
