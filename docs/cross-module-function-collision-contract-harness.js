...
assert.strictEqual(files.length, 390, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 540, 'top-level function inventory must reflect the unsendMsg owner extraction');
