...
assert.strictEqual(files.length, 420, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 510, 'top-level function inventory must reflect the moderatorRecommendBan owner extraction');
