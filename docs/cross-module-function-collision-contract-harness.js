...
assert.strictEqual(files.length, 254, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 676, 'top-level function inventory must reflect the showMsgMenuFromEl owner extraction');
