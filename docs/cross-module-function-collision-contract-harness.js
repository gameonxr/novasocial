...
assert.strictEqual(files.length, 314, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 616, 'top-level function inventory must reflect the adminDeleteContentFromReport owner extraction');
