...
assert.strictEqual(files.length, 409, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 521, 'top-level function inventory must reflect the adminTabAudit owner extraction');
