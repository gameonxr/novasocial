...
assert.strictEqual(files.length, 299, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 631, 'top-level function inventory must reflect the setupLocalMedia owner extraction');
