...
assert.strictEqual(files.length, 272, 'index.html plus 240 extracted scripts must be audited after the DMs renderer split');
assert.strictEqual(seen.size, 658, 'top-level function inventory must reflect the initCallingSystem owner extraction');
