...
**Checkpoint**: Phase 2 core extraction and shared components (`modal.js`, `shared-ui.js`) are isolated on `Branch2`. The `main` branch has not been modified. Static checks pass; modal, navigation, haptic, overlay, and FAB click-through remain required before feature extraction.
